...
from src.handwritten_digit_classifier.components.data_transformation import DataTransformation
from src.handwritten_digit_classifier.config.configuration import ConfigurationManager
from src.handwritten_digit_classifier.logger.logger_config import logger
from src.handwritten_digit_classifier.utils.common import check_file_exists
...
class DataTransformationTrainingPipeline:
    ...
    def data_transformation(self):
        ...
        try:
            ...
            train_loader, val_loader, test_loader = data_transformation.transform()
